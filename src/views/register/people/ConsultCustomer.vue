    ...
    <template v-if="this.$route.path === '/cadastro-pessoas/clientes'">
      <b-container>
        ...
        <div class="mt-3" v-if="listOfCustomers.length > 0">
          <b-table hover striped bordered :items="listOfCustomers" :fields="fields">
        ...
        <template v-if="searchStatus === 400">
          <b-alert class="mt-3 w-75 alert-link" variant="warning" show dismissible>Nenhum Cliente encontrado.</b-alert> 
        </template>	
